...
<ol class="breadcrumb migas_pan">
	...
	<li class="active"><i class="fa fa-shipping-fast"></i><b> Salida Componentes</b></li>
</ol>	
<?php
...
<div  class="container">
	<div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12" id="div_contenido_tabla" >
            <span class="label label-default" style="font-size: 16px;">Listado Salida Componentes</span>
            <div class="text-right" style="margin-top: -25px;">
                <button style="font-weight: bold;" onclick="abrir_modal_registro_salida_componentes()"  data-html="true" title="<b>Registrar Salida Componentes</b>" data-toggle="tooltip" data-placement="bottom" type="button" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Registrar Salida Componentes
                </button>
            </div>
            <div class="table-responsive">
                <table id="tbl_salida_componentes" style="width: 99%; text-align: center;" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Fecha</th>
	    ...
	    <div class="col-lg-12 col-md-12 col-sm-12" id="div_contenido_formulario" style="display: none;"  >
			<form  method="post" name="form_registro_salida_componentes"  id="form_registro_salida_componentes" >
                <input type="hidden" id="op" name="op" value="registro_salida_componentes">
                <input type="hidden" id="id_registro_salida_componentes" name="id_registro_salida_componentes" value="vacio">
    ...
    <div id="modal_detalles_salida" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false' role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="margin-bottom: 35px;">
                    <button type="button" class="close" onclick="cerrar_modal_detalles_salida()">&times;</button>
                ...
                <div class="modal-footer">
                    <button onclick="cerrar_modal_detalles_salida()" style="font-weight: bold;" class="btn btn-danger btn-md">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
...
<?php
	...
	require "footer.php"; ?>
	<script src="js/salida_componentes_tecnico.js"></script>
</body>
</html>
<?php 
