...
<div  class="container">
    ...
    <!-- modal donde se confirma si se quiere poner una orden como registrada  -->
    <div id="modal_confirmacion_registro_orden" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false' role="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header" style="margin-bottom: 35px;">
                    <button type="button" class="close" onclick="cerrar_modal_confirmacion_registro_orden()">&times;</button>
                    <div class="modal-title">
                        <span class="alert alert-success">
                            <img width="32px" src="../public/imagenes/checked.png" >
                            <span  style="font-size: 18px;"><b>Finalizar Orden</b></span>
                        </span> 
                    </div>
                </div>
                <div class="modal-body">
                    <p class="text-success text-center" style="font-size: 18px;">
                        Si esta seguro de marcar la orden como finalizada para actualizar el inventario, presione el botón aceptar <b>ACEPTAR</b>
                    </p>
                    <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12   text-center" id="div_btn_modal_confirmacion_registro_orden" >
                        <button onclick="marcar_registro_orden(this.value)" id="btn_marcar_registro_orden"  data-toggle="tooltip" data-placement="top" data-html="true" title="<b>Presione para poner orden como finilizada</b>" class="btn btn-default btn-md" type="button" ><b>ACEPTAR</b></button>
                        <button onclick="cerrar_modal_confirmacion_registro_orden()" data-toggle="tooltip" data-placement="top" data-html="true" title="<b>Presione para cancelar la acción</b>" class="btn btn-default btn-md" type="button" ><b>CANCELAR</b></button>
                    </div>
                    <p>&nbsp;</p>
                </div>
...
<?php
	...
	require "footer.php"; ?>
	<script src="js/ordenes_ensamblado.js"></script>
</body>
</html>
<?php 
