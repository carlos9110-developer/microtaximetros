...
<ol class="breadcrumb migas_pan">
	...
	<li class="active"><i class="fa fa-shipping-fast"></i><b> Consulta Salida Componentes</b></li>
</ol>	
<?php
	...
	<div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12" id="div_contenido_tabla" >
            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <label for="fecha_consulta">Fecha Consulta Salida Componentes</label>
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <a title='<b>Consultar Salidas</b>' data-html="true" data-toggle="tooltip" data-placement="bottom"  onclick="listar_salida_componentes()" class="btn btn-primary"><span class="fa fa-search"></span></a>
                    </span>
                </div>
            </div>
...
<?php
	...
	require "footer.php"; ?>
	<script src="js/consulta_salida_componentes.js"></script>
</body>
</html>
<?php 
